...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type" id="" class="form-control <?php if ($errors->has('type')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atp3LabExamFinal\resources\views/auth/register.blade.php ENDPATH**/ ?>